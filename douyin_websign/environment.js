(function (global) {
  ...
  function URLSearchParams(value) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      this.items.push([decodeURIComponent(key.replace(/\+/g, " ")), decodeURIComponent(itemValue.replace(/\+/g, " "))]);
    }
  }
  ...
  URLSearchParams.prototype.toString = function () {
    return this.items.map(function (item) {
      return encodeURIComponent(item[0]).replace(/%20/g, "+") + "=" + encodeURIComponent(item[1]).replace(/%20/g, "+");
    }).join("&");
  };
  ...
  Object.defineProperty(URL.prototype, "search", {
    get: function () { var value = this.searchParams.toString(); return value ? "?" + value : ""; },
  ...
  Object.defineProperty(URL.prototype, "href", {
    ...
    set: function (value) {
      ...
      this.protocol = next.protocol; this.host = next.host; this.hostname = next.hostname;
      this.port = next.port; this.pathname = next.pathname; this.hash = next.hash;
  ...
  global.PerformanceObserver = function () { this.observe = function () {}; this.disconnect = function () {}; };
  global.performance = { now: function () { return Date.now(); }, getEntriesByType: function () { return []; } };
  global.fetch = function () { return Promise.resolve({ ok: true, status: 204, json: function () { return Promise.resolve({}); }, text: function () { return Promise.resolve(""); } }); };
