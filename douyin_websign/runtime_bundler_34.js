...
!(function (e) {
  ...
  if (!oe || "undefined" === oe) {
    ((oe = ee()),
      document.cookie.includes("x-web-secsdk-uid") || (document.cookie = "x-web-secsdk-uid=".concat(oe, "; path=/;")));
          ...
          d(
            d(
              d(
                d(
                  d(
                    d(d(ce, t.XHR_RESPONSE_ERROR, "xhr.onerror"), t.FETCH_REQUEST, "window.Request"),
                    t.FETCH_RESPONSE,
                    "window.Response",
                  ),
                  t.COOKIE_GET,
      ...
      d(
        d(
          d(
            d(
              d(
                d(d({}, t.API_LOCALSTORAGE_SET, "ApiStorageSet"), t.API_LOCALSTORAGE_GET, "ApiStorageGet"),
                t.API_SESSIONSTORAGE_SET,
                "ApiStorageSet",
              ),
              t.API_SESSIONSTORAGE_GET,
  ...
  var le = new ((function () {
      return p(
        function e(t, n) {
          (l(this, e), (this.pid = void 0), (this.uid = void 0), (this.strategy = {}), (this.pid = t), (this.uid = n));
        },
        [
          {
              ...
              return (
                Object.keys(e).forEach(function (o) {
                  if ("type" !== o)
                    ...
                    } else "type" === o || "name" === o ? r.push(t.hashMap.get(e[o])) : r.push(e[o]);
                }),
                "[".concat(r.join(","), "]")
              );
            },
          ...
          (l(this, e),
            ...
            (this.gerReportUrl = function () {
              if ("custom" === n.getConfigRegion()) {
                var e = J();
                if (!e) return;
                return "https://".concat(e, "/monitor_browser/collect/batch/security/?bid=").concat(n.getSlardarBid());
              }
              var t,
        ...
        [
            ...
            value: function (e) {
              ...
              var d = S(i, _e),
                E = Object.assign(
                  ...
                  i.eventOverwrite
                    ? this.constructNewDataWithPrifix({ payload: null == i ? void 0 : i.eventOverwrite }, "event")
                    : {},
                  { fromStage: a, documentURL: window.location.href, uId: ue.getUid(), sdkVersion: "1.0.40" },
                ),
                ...
                _ = {
                  ...
                  "user-agent": (null === (t = window.navigator) || void 0 === t ? void 0 : t.userAgent) || "",
                };
                                              ...
                                              u.forEach(function (e) {
                                                void 0 !== e.body.reportString.action_payload &&
                                                  ("event" === e.body.reportString.action_encode &&
                                                    (l.push(JSON.parse(e.body.reportString.action_payload)), (p = e)),
                                                  "request" === e.body.reportString.action_encode &&
                                                    (f.push(JSON.parse(e.body.reportString.action_payload)), (p = e)));
                                              }),
                                              i.convertEventListSchema(l),
                                              i.convertRequestListSchema(f),
                                              p &&
                                                ((p.body.reportString.action_payload = JSON.stringify(i.getResult())),
                                                delete p.body.reportString.event_payload,
                                                c.push(p)),
                                              (n.sampleDataQueue = n.sampleDataQueue.slice(r)),
                                              (h = (function () {
                                                var e = s(
                                                      ...
                                                      for (;;)
                                                        switch ((e.prev = e.next)) {
                                                          case 0:
                                                            ...
                                                            if (he.call(pe, t, JSON.stringify(r))) {
                                                              e.next = 6;
                                                              break;
                                                            }
                                                            return (
                                                              console.log("「sendBecon」send send log report error"),
                                                              (e.next = 6),
                                                              n.logReportByFetch(t, r)
                                                            );
                                                          case 6:
                                                            e.next = 10;
                                                            break;
                                                          case 8:
                                                            return ((e.next = 10), n.logReportByFetch(t, r));
                                                          case 10:
                                                          case "end":
                                                            return e.stop();
                                                        }
          ...
          },
          {
            ...
            value: function (e) {
              var t = function (e) {
                var t = 0;
                return (e.actionType && e.eventType ? (t = 2) : (e.actionType || e.eventType) && (t = 1), t);
              };
    ...
    Ne = (function () {
      return p(
        function e(t, n) {
          (l(this, e), (this.eventName = void 0), (this.payload = void 0), (this.eventName = t), (this.payload = n));
        },
        [
          {
            key: "registEvent",
                  ...
                  try {
                    ...
                    return (
                      ...
                      Te({
                        ...
                        reason: "策略计算异常",
                        payload: t.payload,
                        errorStack: { config: u, name: e.name, message: e.message, detail: e.detail },
                        fromStage: "compute",
                      }),
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              (a.length > 0 ? (i = [a[0]]) : c.length > 0 ? (i = c) : s.length > 0 && (i = [s[0]]), u.length > 0) &&
    ...
    Ie = function (e, n, r) {
      ...
      function l() {
        ...
        if (
          (this === sessionStorage && s && (e = "getItem" === s ? t.API_SESSIONSTORAGE_GET : t.API_SESSIONSTORAGE_SET),
          this === localStorage && s && (e = "getItem" === s ? t.API_LOCALSTORAGE_GET : t.API_LOCALSTORAGE_SET),
        ...
        try {
          ...
          return (
            ...
            Te({ eventName: e, payload: c, reason: "策略引擎执行异常", errorStack: t, fromStage: "select" }),
            u.apply(n, o)
          );
        }
      }
  ...
  ((window.fetch = function (e, n) {
              ...
              we && n.headers instanceof Headers
                ...
                : Array.isArray(n.headers)
                  ...
                  : function (e, t) {
                      ...
                      (null === (o = n) || void 0 === o ? void 0 : o.headers)[e] = i ? "".concat(i, ", ").concat(t) : t;
                    }));
    ...
    Ce(t.XHR_REQUEST_OPEN, "XMLHttpRequest.prototype.open", function (e, t, n) {
      var r = this;
      (r._xhr_open_args || (r._xhr_open_args = {}), Object.assign(r._xhr_open_args, { method: e, url: t, isAsync: n }));
    }),
  ...
  new ((function () {
    return p(
      function e() {
        (l(this, e), (this.projectId = void 0), (this.version = "1.0.40"), (this.customReportHost = ""), this.init());
      },
      [
        {
          key: "init",
          value: function () {
            ...
            ((this.customReportHost = t), (this.projectId = e), this.emitInitReport(), x("coreLoader", this));
          },
        },
        {
          key: "emitInitReport",
          ...
          value: function (e, t, n) {
            ...
            if (o && null != o && null !== (r = o.strategy) && void 0 !== r && r.monitor) {
              var i = o.strategy.monitor.config.sampleRatio,
                a = void 0 === i ? 0 : i;
              1e4 * Math.random() < a &&
                $(e, t, y(y({}, n), {}, { projectId: this.projectId, env: "online", sdkVersion: this.version }));
            }
          },
        },
      ],
          ...
          expression: function (n) {
            ...
            try {
              for (f.s(); !(t = f.n()).done; ) {
                ...
                window !== p && v === h.length && ("===" === d ? u.push(p === y) : "!==" === d && u.push(p !== y));
              }
            } catch (n) {
              f.e(n);
            } finally {
  ...
  (!(function (e, f, d) {
          ...
          try {
            switch (r[f++]) {
              ...
              case 57:
                ...
                break;
              case 45:
                ((n = (r[f] << 8) + r[f + 1]), (f += 2), (l = l - n + 1), (o = p.slice(l, l + n)), (p[l] = o));
                break;
              case 6:
                p[++l] = {};
                break;
              ...
              case 4:
                if (((s = (o = v.pop())[0]), (i = k[0]), 1 === s)) f = o[1];
                  ...
                  if (0 === i) f = o[1];
                    ...
                    if (1 !== i) throw k[1];
                    if (!y) return k[1];
                    ((f = y[1]), (b = y[2]), (h = y[3]), (v = y[4]), (p[++l] = k[1]), (k = [0, null]), (y = y[0]));
                  }
              ...
              case 51:
                ...
                if (s) ((k = [1, o]), (f = s[2]), (s[0] = 0), v.push(s));
                  ...
                  if (!y) return o;
                  ((f = y[1]), (b = y[2]), (h = y[3]), (v = y[4]), (p[++l] = o), (k = [0, null]), (y = y[0]));
                }
                break;
              case 25:
                ((l -= n = r[f++]),
            ...
            try {
              switch (r[f++]) {
                ...
                case 47:
                  ...
                  break;
                case 44:
                  ((n = ((n = (r[f] << 8) + r[f + 1]) << 16) >> 16), (f += 2), v.push([2, 0, f]), (f += n));
                  break;
                case 41:
                  if (((s = (o = v.pop())[0]), (i = k[0]), 1 === s)) f = o[1];
                  else if (0 === s)
    ...
    window.registToGlobal("executeFetchRequest", function (e, f, d) {
      ...
      "csrfWebToken" === f.strategyKey &&
        b === a.REWRITE &&
        (new Headers(c.context.headers).has("x-secsdk-csrf-token") || c.addHeader("x-secsdk-csrf-token", "DOWNGRADE"));
      ...
      envVarDetect: {
        body: {
          ...
          expression: function (e) {
            ...
            return 0 === r.length
              ? { type: "PASS" }
              : { type: a ? "BLOCK" : "REPORT_ONLY", key: r.join(","), once: !0, report: !0, payload: { matched: r } };
          },
        },
        ...
        body: {
          ...
          expression: function (e) {
            ...
            return r && n(r, u.host, c, u.pathname)
              ...
              : { type: n(a, u.host, c, u.pathname) ? i.REWRITE : i.PASS, key: d, once: !0, payload: { url: l } };
          },
        },
        config: {
          protectedHost: {
      ...
      cancelDigg: {
        body: {
          ...
          expression: function (e) {
            ...
            if (w && n(w, s.host, u, s.pathname)) return { type: m.REPORT_ONLY, key: y, once: !0, payload: {} };
